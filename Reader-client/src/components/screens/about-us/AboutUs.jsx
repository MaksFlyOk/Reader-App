		...
		<Layout>
			<section className={styles.wrapper}>
				<div>
					<h1>About us</h1>
					<article>
						<span>There is no us, this app was written by one person.</span>
						<p>
							Hi by the way, I have about 6 months of training under my belt,
							this project is being written to practice React. Oops, my GitHub
							is down there, unless of course you are on it now....
						</p>
						<div>
							<a
				...
				<figure>
					<img src='/public/about-us/Logo.svg' alt='Logo' draggable={false} />
				</figure>
			</section>
		</Layout>
	)
